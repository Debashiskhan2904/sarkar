...
export const Contact = () => {
  ...
  const handleCopyUpi = () => {
    navigator.clipboard.writeText('Vyapar.170854583865@hdfcbank');
    setCopiedUpi(true);
    showToast('UPI ID copied to clipboard: Vyapar.170854583865@hdfcbank', 'success');
    setTimeout(() => setCopiedUpi(false), 3000);
  };

  const handleCopyAcc = () => {
    navigator.clipboard.writeText('50200102953505');
    setCopiedAcc(true);
    showToast('A/C Number copied: 50200102953505', 'success');
    setTimeout(() => setCopiedAcc(false), 3000);
  };

  const handleCopyIfsc = () => {
    navigator.clipboard.writeText('HDFC0001257');
    setCopiedIfsc(true);
    showToast('IFSC Code copied: HDFC0001257', 'success');
    ...
    <PageWrapper>
      <section className="section" style={{ paddingTop: '50px', paddingBottom: '80px' }}>
        <div className="container">
          ...
          {/* Advance Payment & QR Code Section matching user official reference */}
          <OfficialQRPayment className="my-16" />
