      ...
      <section className="quick-connect-section">
        <div className="container">
          <motion.div 
            ...
            transition={{ duration: 0.6 }}
          >
            <div className="quick-connect-eyebrow">{t('quickConnectEyebrow')}</div>
            <h2 className="quick-connect-title">{t('quickConnectTitle')}</h2>
          </motion.div>
          ...
          <div className="quick-connect-grid">
            ...
            >
              ...
              <h3 className="cc-title">{t('callUsTitle')}</h3>
              <p className="cc-subtext">{t('callUsSub')}</p>
            ...
            >
              ...
              <h3 className="cc-title">{t('emailUsTitle')}</h3>
              <p className="cc-subtext" style={{ whiteSpace: 'pre-line' }}>
                {t('emailUsSub')}
              </p>
            ...
            >
              ...
              <h3 className="cc-title">{t('visitUsTitle')}</h3>
              <p className="cc-subtext" style={{ whiteSpace: 'pre-line' }}>
                {t('visitUsSub')}
              </p>
              <a 
              ...
              >
                <ExternalLink size={14} /> {t('btnGetDirections')}
              </a>
            </motion.div>
            ...
            >
              ...
              <h3 className="cc-title">{t('whatsappTitle')}</h3>
              <p className="cc-subtext">{t('whatsappSub')}</p>
              <a 
              ...
              >
                <MessageCircle size={14} /> {t('btnChatWhatsapp')}
              </a>
            </motion.div>
      ...
      <section className="section" style={{ paddingTop: '60px' }}>
        <div className="container">
          <div className="legal-content">
            <h2>{t('legalFrameworkTitle')}</h2>
            <p style={{ color: 'var(--gray)', marginBottom: '32px' }}>{t('legalFrameworkSub')}</p>
            ...
            <div id="privacy" style={{ scrollMarginTop: '100px', marginBottom: '40px' }}>
              ...
              <h4>{t('legalDataStorageHeading')}</h4>
              <p>{t('legalDataStorageText')}</p>
            </div>
