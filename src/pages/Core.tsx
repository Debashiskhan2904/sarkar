...
import { MapPin, Phone, Mail, ShoppingCart, Gem, Home as HomeIcon, Sparkles, MessageCircle, Copy, Check, ExternalLink, Send, QrCode } from 'lucide-react';
    ...
    <PageWrapper>
      <section className="hero">
        <video 
          ...
          playsInline 
          preload="none"
          poster="https://images.pexels.com/videos/3129957/free-video-3129957.jpg"
        >
...
export const About = () => {
  ...
  return (
    <PageWrapper>
      ...
      {/* The Journey Section */}
      <JourneySection showSectionHeader={false} />
...
export const Contact = () => {
  ...
  const submitAdvancePayment = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showToast(err?.message || 'Payment logging error. Please try again.', 'error');
    } finally {
        ...
        <div className="container">
          ...
          <div className="quick-connect-grid">
            ...
            >
              ...
              <p className="cc-subtext">+91 8670783810</p>
            ...
            >
              ...
              <div className="cc-subtext" style={{ display: 'flex', flexDirection: 'column', gap: '3px', marginBottom: '14px' }}>
                <a 
                  href="mailto:bpkishore2001@gmail.com?subject=Business%20Inquiry%20-%20Sarkar%20Enterprise" 
                ...
                <a 
                  href="mailto:kishore8670@gmail.com?subject=Business%20Inquiry%20-%20Sarkar%20Enterprise" 
                  style={{ color: 'rgba(255,255,255,0.7)', textDecoration: 'none', fontSize: '0.85rem', transition: 'color 0.2s ease' }}
                  onMouseEnter={(e) => (e.currentTarget.style.color = '#FFD700')}
              ...
              <a href="mailto:bpkishore2001@gmail.com?subject=Business%20Inquiry%20-%20Sarkar%20Enterprise" className="cc-btn btn-gold-outline">
            ...
            >
              ...
              <p className="cc-subtext">
                ...
                <strong>GSTIN:</strong> 19BZSPS5314M1ZG
              </p>
              <a 
          ...
          >
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 220px), 1fr))', gap: '24px', alignItems: 'center', background: '#050505', padding: 'clamp(14px, 3vw, 24px)', borderRadius: '12px', border: '1px solid rgba(255, 255, 255, 0.08)', marginBottom: '28px', width: '100%', boxSizing: 'border-box' }}>
              <div style={{ textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                <div style={{ background: '#ffffff', padding: '12px', borderRadius: '12px', boxShadow: '0 8px 24px rgba(0,0,0,0.6)' }}>
                  <img 
                    src="/images/payments/qr.jpeg" 
                    alt="Sarkar Enterprise UPI QR Code" 
                    style={{ width: '100%', maxWidth: '200px', height: 'auto', display: 'block', borderRadius: '6px' }} 
                    onError={(e) => {
                      (e.target as HTMLImageElement).src = "/images/payments/QR.png";
                    }}
                  />
                </div>
                <div 
              ...
              <div>
                ...
                <p style={{ color: 'rgba(255,255,255,0.9)', fontSize: '0.92rem', margin: '0 0 8px 0', lineHeight: '1.5' }}>
                  <strong style={{ color: '#ffffff' }}>{t('contactAccName')}</strong> SARKAR ENTERPRISE
                </p>
                <p style={{ color: 'rgba(255,255,255,0.9)', fontSize: '0.92rem', margin: '0 0 8px 0', lineHeight: '1.5' }}>
                ...
                <p style={{ color: 'rgba(255,255,255,0.9)', fontSize: '0.92rem', margin: '0', lineHeight: '1.5' }}>
                  <strong style={{ color: '#ffffff' }}>{t('contactGst')}</strong> 19BZSPS5314M1ZG
                </p>
              </div>
            </div>
            ...
            <div style={{ 
              ...
              {paySubmitted ? (
                ...
                <form onSubmit={submitAdvancePayment} style={{ width: '100%', boxSizing: 'border-box' }}>
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 240px), 1fr))', gap: '16px', marginBottom: '16px', width: '100%', boxSizing: 'border-box' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 240px), 1fr))', gap: '16px', marginBottom: '20px', width: '100%', boxSizing: 'border-box' }}>
                    <div className="cc-form-group">
                      <label style={{ color: '#d4d4d4', fontSize: '0.85rem', fontWeight: 600, marginBottom: '6px', display: 'block' }}>
...
export const Legal = () => {
  ...
  return (
    <PageWrapper>
      <section className="section" style={{ paddingTop: '50px', paddingBottom: '80px' }}>
        <div className="container">
          <div className="legal-content" style={{ maxWidth: '1200px', width: '100%', margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: '36px' }}>
              ...
              <h2 style={{ fontSize: 'clamp(1.8rem, 4vw, 2.5rem)', fontFamily: "'Playfair Display', serif", marginTop: '12px', marginBottom: '8px' }}>
                {t('legalPageFrameworkTitle')}
              </h2>
              <p style={{ color: 'var(--gray)', fontSize: '0.98rem' }}>{t('legalFrameworkSub')}</p>
            ...
            <div id="agreement" style={{ scrollMarginTop: '100px', marginBottom: '50px', width: '100%' }}>
              <div style={{ marginBottom: '16px' }}>
                <h3 style={{ color: '#FFD700', fontSize: 'clamp(1.3rem, 2.5vw, 1.6rem)', borderBottom: '1px solid rgba(255,215,0,0.3)', paddingBottom: '8px', display: 'flex', alignItems: 'center', gap: '10px' }}>
                  <span>📜</span> Legal Contractual Agreement
                </h3>
                <p style={{ color: 'rgba(255,255,255,0.8)', fontSize: '0.92rem', marginTop: '6px', lineHeight: '1.6' }}>
            ...
            <div id="privacy" style={{ scrollMarginTop: '100px', marginBottom: '32px', background: 'rgba(255,255,255,0.02)', padding: 'clamp(20px, 3.5vw, 32px)', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.08)', width: '100%', boxSizing: 'border-box' }}>
              <h3 style={{ color: '#FFD700', fontSize: 'clamp(1.2rem, 2.2vw, 1.4rem)', borderBottom: '1px solid rgba(255,215,0,0.2)', paddingBottom: '8px', margin: '0 0 14px 0' }}>{t('legalPrivacyHeading')}</h3>
              <p style={{ marginTop: '12px', lineHeight: '1.7', textAlign: 'left' }}>{t('legalPrivacyIntro')}</p>

              <h4 style={{ color: '#fff', marginTop: '18px', marginBottom: '8px' }}>{t('legalHowWeUseData')}</h4>
              ...
              <h4 style={{ color: '#fff', marginTop: '18px', marginBottom: '8px' }}>{t('legalDataStorageHeading')}</h4>
              <p style={{ lineHeight: '1.7', textAlign: 'left' }}>{t('legalDataStorageText')}</p>
            </div>

            <div id="terms" style={{ scrollMarginTop: '100px', marginBottom: '32px', background: 'rgba(255,255,255,0.02)', padding: 'clamp(20px, 3.5vw, 32px)', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.08)', width: '100%', boxSizing: 'border-box' }}>
              <h3 style={{ color: '#FFD700', fontSize: 'clamp(1.2rem, 2.2vw, 1.4rem)', borderBottom: '1px solid rgba(255,215,0,0.2)', paddingBottom: '8px', margin: '0 0 14px 0' }}>{t('legalTermsHeading')}</h3>
              <p style={{ marginTop: '12px', lineHeight: '1.7', textAlign: 'left' }}>{t('legalTermsIntro')}</p>
              <ul style={{ paddingLeft: '20px', lineHeight: '1.7' }}>
                <li>{t('legalTerms1')}</li>
                <li>{t('legalTerms2')}</li>
                <li>{t('legalTerms3')}</li>
            ...
            <div id="cookies" style={{ scrollMarginTop: '100px', marginBottom: '32px', background: 'rgba(255,255,255,0.02)', padding: 'clamp(20px, 3.5vw, 32px)', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.08)', width: '100%', boxSizing: 'border-box' }}>
              <h3 style={{ color: '#FFD700', fontSize: 'clamp(1.2rem, 2.2vw, 1.4rem)', borderBottom: '1px solid rgba(255,215,0,0.2)', paddingBottom: '8px', margin: '0 0 14px 0' }}>{t('legalCookieHeading')}</h3>
              <p style={{ marginTop: '12px', lineHeight: '1.7', textAlign: 'left' }}>{t('legalCookieText')}</p>
            </div>
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '12px', borderBottom: '1px solid rgba(255, 215, 0, 0.25)', paddingBottom: '14px', marginBottom: '16px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                  <div style={{ background: 'rgba(255, 215, 0, 0.15)', color: '#FFD700', padding: '10px', borderRadius: '10px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <QrCode size={24} />
                  </div>
                  <h3 style={{ color: '#FFD700', fontSize: 'clamp(1.3rem, 2.5vw, 1.6rem)', margin: 0, fontFamily: "'Playfair Display', serif", fontWeight: 700 }}>
                    {t('legalPaymentHeading')}
                  </h3>
                </div>
                <span style={{ background: 'rgba(255, 215, 0, 0.12)', color: '#FFD700', border: '1px solid rgba(255, 215, 0, 0.3)', padding: '5px 14px', borderRadius: '20px', fontSize: '0.75rem', fontWeight: 800, letterSpacing: '0.08em' }}>
                  OFFICIAL ESCROW &amp; GST BILLING
                </span>
              </div>

              <p style={{ color: 'rgba(255, 255, 255, 0.88)', fontSize: '1.02rem', lineHeight: '1.7', margin: '0 0 20px 0', textAlign: 'left', overflowWrap: 'break-word' }}>
                {t('legalPaymentText')}
              </p>
