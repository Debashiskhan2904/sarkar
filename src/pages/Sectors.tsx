...
import { ProductJsonLd, ProductSchemaItem } from '../components/StructuredData';
...
export const ProductsHub = () => {
  ...
  // Eager pre-caching of product showcase images and logos
  useEffect(() => {
    const priorityAssets = [
      'https://i.pinimg.com/736x/9f/63/a9/9f63a9ae3bb1b1da075a53c362e56abd.jpg',
      'https://i.pinimg.com/736x/b1/61/57/b161574feafbb517bd5a5685e3de085d.jpg',
      'https://i.pinimg.com/736x/d6/16/1e/d6161e0676203b2168b0c1d3b5ca4650.jpg',
      'https://i.pinimg.com/736x/4f/78/f4/4f78f4cbb438ecb514d738868bcff1f7.jpg',
      'https://i.pinimg.com/736x/29/4a/e3/294ae38e278b2933d4e945e200f5ebd4.jpg',
      'https://i.pinimg.com/736x/f6/ba/6f/f6ba6fa66f50c79a11a5dd66a253be99.jpg',
  ...
  // Fixed permanent official FMCG visuals for the lightbox zoom modal
  const pritiJiVisuals = useMemo(() => [
    { url: 'https://i.pinimg.com/736x/9f/63/a9/9f63a9ae3bb1b1da075a53c362e56abd.jpg', title: '1st: Priti-Ji Green Chilli Special Jhal Ayurvedic Pack' },
    { url: 'https://i.pinimg.com/736x/63/e9/d2/63e9d21494581cc8af1fe6b4ea9c3749.jpg', title: '2nd: Priti-Ji Official Dealership Leaflet & Scheme' },
    { url: 'https://i.pinimg.com/736x/af/0e/1f/af0e1f2bbb6c9a9fdbe28c01ce46bdce.jpg', title: '3rd: Priti-Ji Yasti Madhu Misti & Salty Digestive Packets' },
    { url: 'https://i.pinimg.com/736x/4f/78/f4/4f78f4cbb438ecb514d738868bcff1f7.jpg', title: '4th: Priti-Ji FMCG Product Catalog & Distribution Scheme' },
    { url: '/images/logos/pritilogo.webp', title: 'Priti-Ji Official Brand Logo & Identity' }
  ], []);

  const mosquitoVisuals = useMemo(() => [
    { url: 'https://i.pinimg.com/736x/b1/61/57/b161574feafbb517bd5a5685e3de085d.jpg', title: '1st: Angry Frog Anti Mosquito Instant Kill Vaporizer' },
    { url: 'https://i.pinimg.com/736x/c2/03/f7/c203f70725f20c7ebb0ef983cad7b98f.jpg', title: '2nd: Maxwell & Encounter Mosquito Repellent Coil & Sticks' },
    { url: 'https://i.pinimg.com/736x/03/5c/cf/035ccf72925e3420c10f5e10c339cbb3.jpg', title: '3rd: Citronella Agarbatti & Standee Campaign Kit' },
    { url: 'https://i.pinimg.com/736x/4f/78/f4/4f78f4cbb438ecb514d738868bcff1f7.jpg', title: '4th: Mosquito Repellent Regional Trade & Supply Blueprint' },
    { url: '/images/logos/mosquito.webp', title: 'Angry Frog Instant Kill Brand Logo' }
  ], []);

  const soanPapdiVisuals = useMemo(() => [
    { url: 'https://i.pinimg.com/736x/d6/16/1e/d6161e0676203b2168b0c1d3b5ca4650.jpg', title: '1st: Munmun Food Products – Soan Papdi & Others' },
    { url: 'https://i.pinimg.com/736x/4f/78/f4/4f78f4cbb438ecb514d738868bcff1f7.jpg', title: '2nd: Munmun Food Products Distribution & Trade Scheme' },
    { url: '/images/logos/soanpapdilogo.webp', title: 'Munmun Food Products Official Logo' }
  ], []);

  // Fixed permanent official collections for Jewellery and Interiors (NEVER changed by uploaded media)
  const jewelleryPhotos = JEWELLERY_GALLERY;
  const interiorPhotos = INTERIOR_GALLERY;
  ...
  const structuredProducts: ProductSchemaItem[] = useMemo(() => [
    {
      name: 'Priti-Ji Ayurvedic Chanachur (200g)',
      description: 'Crispy, premium digestive Ayurvedic Chanachur prepared with dry fruit base, green chilli special jhal, hing, and carom seeds.',
      image: 'https://i.pinimg.com/736x/d9/4f/27/d94f27adb01975c919f11aa8a998eb87.jpg',
      category: 'FMCG & Packaged Foods',
      sku: 'FMCG-PRITIJI-200G',
      brand: 'Priti-Ji Ayurvedic',
      price: '70.00',
      priceCurrency: 'INR',
    ...
    {
      name: 'Angry Frog Fast Mosquito Killer Liquid & Citronella Agarbatti',
      description: 'Instant protection mosquito repellent system and citronella incense sticks with universal machine fit and high dealer margin.',
      image: 'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=800',
      category: 'Home Care & Pest Control',
      sku: 'FMCG-ANGRYFROG-VAP',
      brand: 'Angry Frog',
      price: '85.00',
      priceCurrency: 'INR',
      availability: 'InStock',
    ...
    {
      name: 'Munmun Desi Ghee & Elaichi Soan Papdi Box',
      description: 'Traditional Indian sweet delicacy prepared with pure desi ghee, crushed cardamom, and fine pistachio flakes in tamper-evident sealed trays.',
      image: 'https://images.unsplash.com/photo-1599488615731-7e5c2823ff28?w=800',
      category: 'Confectionery & Sweets',
      sku: 'FMCG-MUNMUN-SOAN',
      brand: 'Munmun Food Products',
      price: '120.00',
      priceCurrency: 'INR',
      availability: 'InStock',
    ...
    {
      name: 'Stylo Jewellery Monopoly Franchise Outlet Agreement (M1 / Y4 / 6-Year Scheme)',
      description: 'Monopoly territory franchise scheme for jewellery showroom partners with 6-year bank interest parity and stock buyback guarantee.',
      image: 'https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=800',
      category: 'Franchise & Retail Opportunity',
      sku: 'STYLO-JEWEL-M1Y4',
      brand: 'Stylo Jewellery Division',
      price: '500000.00',
      priceCurrency: 'INR',
      availability: 'InStock',
      ratingValue: '5.0',
    ...
    {
      name: 'The Sarkar Enterprise Turnkey Luxury Interiors & Infrastructure',
      description: 'Complete architectural space planning, modular workstations, executive suites, and branded retail turnkey execution across West Bengal.',
      image: 'https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?w=800',
      category: 'Interior Design & Architecture',
      sku: 'INT-TURNKEY-COMM',
      brand: 'Sarkar Interiors & Infrastructure',
      price: '250000.00',
      priceCurrency: 'INR',
      availability: 'InStock',
      ratingValue: '4.9',
  ...
  return (
    <PageWrapper>
      {/* Schema.org Product & ItemList Structured Data for Google Search Rich Snippets */}
      <ProductJsonLd products={structuredProducts} />
        ...
        <div className="container">
          ...
          <div className="fmcg-showcase-container">
            ...
            <PritiJiShowcase 
              ...
              onViewVisuals={() => openZoomGallery(pritiJiVisuals, 0, t('pritiJiTitle'))}
            />
            ...
            <MosquitoRepellentsShowcase 
              onOpenEnquiry={(title, cat) => handleOpenBuyingEnquiry(title, cat)}
              onWhatsAppOrder={(title) => handleSendWhatsAppOrder(title)}
              onViewVisuals={() => openZoomGallery(mosquitoVisuals, 0, t('mosquitoTitle'))}
            />
            ...
            <SoanPapdiShowcase 
              onOpenEnquiry={(title, cat) => handleOpenBuyingEnquiry(title, cat)}
              onWhatsAppOrder={(title) => handleSendWhatsAppOrder(title)}
              onViewVisuals={() => openZoomGallery(soanPapdiVisuals, 0, t('soanPapdiTitle'))}
            />
          </div>
        </div>
      </section>
            ...
            <div className="ps-gallery-wrapper">
              <div className="flex items-center justify-between mb-4 flex-wrap gap-2">
                ...
                <span className="text-xs font-semibold text-amber-400 bg-amber-400/10 border border-amber-400/20 px-3 py-1 rounded-full">
                  {jewelleryPhotos.length} {t('officialSchemeDocs')}
                </span>
              </div>
        ...
        <div className="container">
          ...
          {interiorPhotos.length > 0 && (
            <div className="ps-gallery-wrapper mt-8">
              <div className="flex items-center justify-between mb-4 flex-wrap gap-2">
                <h3 className="ps-gallery-title mb-0">{t('galleryInteriorTitle')}</h3>
                <span className="text-xs font-semibold text-emerald-400 bg-emerald-400/10 border border-emerald-400/20 px-3 py-1 rounded-full">
                  {interiorPhotos.length} {t('officialBlueprintDocs')}
                </span>
              </div>
              <div className="ps-gallery-grid four-cols">
              ...
              >
                ...
                {inquirySuccess ? (
                  <div className="p-6 text-center space-y-3.5">
                    ...
                    <h4 className="text-lg font-bold text-white">{t('enquirySuccessTitle')}</h4>
                    ...
                    <div className="pt-2 flex flex-col sm:flex-row gap-2.5 justify-center">
                      ...
                      >
                        <MessageCircle size={16} /> {t('enquiryWhatsAppChatNow')}
                      </button>
                      <button
                        type="button"
                        onClick={() => setBuyingModalProduct(null)}
                  ...
                  <form onSubmit={handleInquirySubmit} className="p-4 sm:p-5 space-y-3">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                      <div>
                        <label className="block text-[11px] font-semibold text-gray-300 mb-1">{t('enquiryLabelFullName')}</label>
                        <input 
                          type="text"
                          required
                      ...
                      <div>
                        <label className="block text-[11px] font-semibold text-gray-300 mb-1">{t('enquiryLabelPhone')}</label>
                        <input 
                          type="tel"
                          required
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                      <div>
                        <label className="block text-[11px] font-semibold text-gray-300 mb-1">{t('enquiryLabelDistrict')}</label>
                        <input 
                          type="text"
                      ...
                      <div>
                        <label className="block text-[11px] font-semibold text-gray-300 mb-1">{t('enquiryLabelRole')}</label>
                        <select
                          value={inquiryForm.role}
                          onChange={(e) => setInquiryForm({ ...inquiryForm, role: e.target.value })}
                          className="w-full bg-[#1c202a] border border-white/15 rounded-lg px-3 py-2 text-xs text-white focus:outline-none focus:border-gold"
                        >
                          <option value="Dealer / Wholesaler">{t('enquiryRoleDealer')}</option>
                          <option value="Hawker / Cycle Sales">{t('enquiryRoleHawker')}</option>
                          <option value="Retail Grocery Shop">{t('enquiryRoleRetail')}</option>
                          <option value="C&F / Area Distributor">{t('enquiryRoleCnF')}</option>
                          <option value="Direct Buyer / Bulk">{t('enquiryRoleDirect')}</option>
                        </select>
                      </div>
                    </div>

                    <div>
                      <label className="block text-[11px] font-semibold text-gray-300 mb-1">{t('enquiryLabelQuantity')}</label>
                      <input 
                        type="text"
                    ...
                    <div>
                      <label className="block text-[11px] font-semibold text-gray-300 mb-1">{t('enquiryLabelQuestions')}</label>
                      <textarea 
                        rows={2}
                    ...
                    <div className="pt-2 flex flex-col sm:flex-row items-center gap-2.5">
                      ...
                      >
                        {isSubmittingInquiry ? t('enquirySubmittingBtn') : t('enquirySubmitBtn')}
                      </button>
                      <button
                        type="button"
                        onClick={() => handleSendWhatsAppOrder(buyingModalProduct.title)}
                      ...
                      >
                        <MessageCircle size={15} /> {t('enquiryWhatsAppDirect')}
                      </button>
                    </div>
                  </form>
                )}
