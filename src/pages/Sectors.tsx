...
export const ProductsHub = () => {
  ...
  useEffect(() => {
    const priorityAssets = [
      ...
      'https://i.pinimg.com/736x/7e/96/66/7e9666da41cba6e52804e399933e491f.jpg',
  ...
  const soanPapdiVisuals = useMemo(() => [
    { url: 'https://i.pinimg.com/736x/d6/16/1e/d6161e0676203b2168b0c1d3b5ca4650.jpg', title: 'Munmun Food Products – Soan Papdi & Others' },
    { url: 'https://i.pinimg.com/736x/d6/16/1e/d6161e0676203b2168b0c1d3b5ca4650.jpg', title: 'Munmun Pure Desi Ghee Soan Papdi Platter' },
    { url: 'https://i.pinimg.com/736x/d6/16/1e/d6161e0676203b2168b0c1d3b5ca4650.jpg', title: 'Munmun Food Products Confectionery Collection' },
