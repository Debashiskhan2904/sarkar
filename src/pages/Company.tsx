...
import { 
  ...
  IndianRupee, Building2, ChevronRight, PhoneCall, X, Send, Users, Check, HelpCircle, Search, ShoppingBag, Tag, Filter
} from 'lucide-react';
      ...
      <section className="section" style={{ paddingTop: '50px', paddingBottom: '80px', background: '#0a0d12' }}>
        <div className="container" style={{ maxWidth: '1140px', margin: '0 auto' }}>
          ...
          <div style={{ 
            ...
            <a 
              href="https://wa.me/918670783810?text=Hello%20Sarkaar%20Enterprise%20HR,%20I%20want%20to%20inquire%20about%20career%20openings."
              target="_blank"
...
export const Media = () => {
  ...
  const getFallbackSvg = (title: string) => {
    const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="800" height="600" viewBox="0 0 800 600">
      ...
      <text x="50%" y="410" dominant-baseline="middle" text-anchor="middle" fill="#d4af37" font-family="sans-serif" font-size="18">Sarkaar Enterprise Official Media Asset</text>
    </svg>`;
  ...
  const handleRequestMediaKit = () => {
    ...
    const msg = encodeURIComponent(`Hello Sarkaar Enterprise, I am interested in your ${topic} products and would like to request the complete Media Kit, Catalog & Blueprint Credentials.`);
        ...
        <div className="container faq-container">
          ...
          >
            ...
            <div className="faq-cta-btns">
              ...
              <a 
                href="https://wa.me/918670783810?text=Hello%20Sarkaar%20Enterprise%2C%20I%20have%20a%20query." 
                target="_blank" 
                rel="noreferrer"
