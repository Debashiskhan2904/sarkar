        ...
        <div className="container" style={{ maxWidth: '1240px', width: '100%' }}>
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '18px' }}>
              <div style={{ background: 'rgba(255, 215, 0, 0.15)', color: '#FFD700', padding: '10px', borderRadius: '10px', border: '1px solid rgba(255, 215, 0, 0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <Building2 size={24} />
              </div>
              <h2 style={{ fontSize: 'clamp(1.3rem, 2.5vw, 1.65rem)', color: '#ffffff', margin: 0, fontFamily: "'Playfair Display', serif", fontWeight: 700 }}>
                {t('conclusionOverviewTitle')}
              </h2>
            </div>

            <p style={{ color: 'rgba(255, 255, 255, 0.88)', fontSize: '1.02rem', lineHeight: '1.75', marginBottom: '16px', textAlign: 'left', overflowWrap: 'break-word' }}>
              {t('conclusionOverviewP1')}
            </p>

            <p style={{ color: 'rgba(255, 255, 255, 0.88)', fontSize: '1.02rem', lineHeight: '1.75', margin: 0, textAlign: 'left', overflowWrap: 'break-word' }}>
          ...
          <div style={{ marginBottom: '40px', width: '100%' }}>
            <div style={{ textAlign: 'center', marginBottom: '24px' }}>
              ...
              <h3 style={{ fontSize: 'clamp(1.4rem, 3vw, 1.9rem)', color: '#fff', fontFamily: "'Playfair Display', serif", marginTop: '6px' }}>
                {t('conclusionSectorsTitle')}
              </h3>
              <p style={{ color: 'rgba(255, 255, 255, 0.7)', maxWidth: '780px', margin: '0 auto', fontSize: '0.95rem' }}>
                {t('conclusionSectorsSubtitle')}
              </p>
            </div>

            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(min(100%, 260px), 1fr))', gap: '16px', width: '100%' }}>
              {businessSectors.map((sector) => (
                ...
                >
                  ...
                  <p style={{ color: 'rgba(255, 255, 255, 0.72)', fontSize: '0.86rem', lineHeight: '1.5', margin: 0, textAlign: 'left', overflowWrap: 'break-word' }}>
                    {t(sector.descKey)}
                  </p>
                </div>
              ))}
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 420px), 1fr))', gap: '20px', marginBottom: '40px', width: '100%' }}>
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '16px' }}>
                <div style={{ background: 'rgba(255, 215, 0, 0.15)', color: '#FFD700', padding: '8px', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <Layers size={20} />
                </div>
                <h3 style={{ fontSize: 'clamp(1.2rem, 2.2vw, 1.4rem)', color: '#fff', margin: 0, fontFamily: "'Playfair Display', serif", fontWeight: 700 }}>
                  {t('conclusionCapTitle')}
                </h3>
              </div>

              <p style={{ color: 'rgba(255, 255, 255, 0.85)', fontSize: '0.95rem', lineHeight: '1.7', marginBottom: '16px', textAlign: 'left', overflowWrap: 'break-word' }}>
                {t('conclusionCapP1')}
              </p>

              <p style={{ color: 'rgba(255, 255, 255, 0.85)', fontSize: '0.95rem', lineHeight: '1.7', margin: 0, textAlign: 'left', overflowWrap: 'break-word' }}>
                {t('conclusionCapP2')}
              </p>
            </div>
          ...
          >
            <div style={{ textAlign: 'center', marginBottom: '24px' }}>
              ...
              <h3 style={{ fontSize: 'clamp(1.4rem, 2.8vw, 1.8rem)', color: '#fff', fontFamily: "'Playfair Display', serif", marginTop: '6px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 240px), 1fr))', gap: '16px', width: '100%' }}>
              {growthPrinciples.map((pillar) => (
                ...
                >
                  ...
                  <p style={{ color: 'rgba(255, 255, 255, 0.75)', fontSize: '0.86rem', lineHeight: '1.55', margin: 0, textAlign: 'left', overflowWrap: 'break-word' }}>
                    {t(pillar.descKey)}
                  </p>
                </div>
              ))}
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '20px' }}>
              <div style={{ background: '#FFD700', color: '#000', padding: '10px', borderRadius: '10px', fontWeight: 900, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <Target size={24} />
              </div>
              <h2 style={{ fontSize: 'clamp(1.35rem, 2.8vw, 1.75rem)', color: '#FFD700', margin: 0, fontFamily: "'Playfair Display', serif", fontWeight: 700 }}>
                {t('conclusionObjTitle')}
              </h2>
            </div>

            <p style={{ color: 'rgba(255, 255, 255, 0.9)', fontSize: '1.02rem', lineHeight: '1.75', marginBottom: '18px', textAlign: 'left', overflowWrap: 'break-word' }}>
              {t('conclusionObjP1')}
            </p>
            ...
            <p style={{ color: 'rgba(255, 255, 255, 0.9)', fontSize: '1.02rem', lineHeight: '1.75', marginBottom: '20px', textAlign: 'left', overflowWrap: 'break-word' }}>
              {t('conclusionObjP3')}
            </p>

            <div style={{ background: 'rgba(255, 215, 0, 0.1)', borderLeft: '4px solid #FFD700', padding: '16px 20px', borderRadius: '0 8px 8px 0', margin: '20px 0 0 0' }}>
              <p style={{ color: '#ffffff', fontSize: '1.05rem', lineHeight: '1.7', fontWeight: 600, margin: 0, fontStyle: 'italic', textAlign: 'left' }}>
                {t('conclusionQuote')}
              </p>
            </div>
          </div>
