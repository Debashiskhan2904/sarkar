...
export const PritiJiShowcase: React.FC<PritiJiShowcaseProps> = ({
  ...
  const bullets = [
    'Dealer Price from ₹60–70 combo pack',
    'Credit Limit 15 days',
    'Free gifts & promotional support',
    '100% Dealer Promotion + Extra ₹18k Income p.m. possible',
    'Suitable for retail, wholesale, canteen, travel & modern trade',
    'High demand – proven taste and repeat customers',
    'Brand support and marketing materials provided',
    'Available in multiple flavours: Lemon Tak, Jhal-Misti, Yasti Madhu Misti/Salty, Green Chilli'
  ];

  // Chips matching screenshot
  const tags = [
    { text: '₹60–70 Combo Pack', highlight: true },
    { text: '15-Day Credit Limit', highlight: true },
    { text: '+₹18,000/mo Dealer Scheme', highlight: true },
    { text: 'Dry Fruit Ayurvedic Base', highlight: true },
    { text: 'Tak-Jhal-Misti • Yasti Madhu • Green Chilli', highlight: false },
    { text: 'No Preservatives', highlight: false },
    { text: 'High Repeat Demand', highlight: false }
  ];
      ...
      <div className="pritiji-banner-card">
        ...
        <div className="pritiji-spec-column">
          ...
          <div className="spec-header-row">
            <div className="spec-header-left">
              ...
              <div className="spec-title-texts">
                <span className="spec-eyebrow">PRITIJI AYURVEDIC SPECIAL</span>
                <h2 className="spec-main-title">Priti-Ji Chanachur</h2>
              </div>
            </div>
            ...
            <div className="now-in-durgapur-badge">
              <div className="durgapur-brush-bg">
                <span className="durgapur-text-small">Now in</span>
                <span className="durgapur-text-bold">Durgapur!</span>
              </div>
            </div>
          </div>
          ...
          <p className="spec-description">
            Dry Fruit Base Ayurvedic Chanachur – First time in West Bengal. A unique blend of taste and health. 
            Digestive, protein rich, with traditional Ayurvedic masala. 
            Available in Lemon Tak, Jhal-Misti, Yasti Madhu Misti/Salty & Green Chilli Special Jhal.
          </p>
          ...
          <div className="spec-bullets-and-banner">
            ...
            <div className="spec-healthy-habit-banner">
              <div className="healthy-habit-brush">
                <span className="habit-line-1">More than a Snack</span>
                <span className="habit-line-2">It's a Healthy Habit!</span>
