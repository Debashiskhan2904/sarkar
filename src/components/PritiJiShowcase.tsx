  ...
  const pritiImages = [
    {
      ...
      webpUrl: 'https://i.pinimg.com/736x/9f/63/a9/9f63a9ae3bb1b1da075a53c362e56abd.jpg',
    ...
    },
    {
      ...
      webpUrl: 'https://i.pinimg.com/736x/63/e9/d2/63e9d21494581cc8af1fe6b4ea9c3749.jpg',
      url: 'https://i.pinimg.com/736x/63/e9/d2/63e9d21494581cc8af1fe6b4ea9c3749.jpg',
    ...
    },
    {
      ...
      webpUrl: 'https://i.pinimg.com/736x/af/0e/1f/af0e1f2bbb6c9a9fdbe28c01ce46bdce.jpg',
      url: 'https://i.pinimg.com/736x/af/0e/1f/af0e1f2bbb6c9a9fdbe28c01ce46bdce.jpg',
      remoteUrl: 'https://i.pinimg.com/736x/af/0e/1f/af0e1f2bbb6c9a9fdbe28c01ce46bdce.jpg'
    },
    {
      id: 'img-4',
      indexLabel: '4th',
      title: '4th: Priti-Ji FMCG Product Catalog & Distribution Scheme',
      sub: 'Commercial Distribution Strategy & Regional Retail Network Scheme',
          ...
          >
            ...
            <div className="flex items-center justify-between w-full pb-2 mb-2 border-b border-gray-800 shrink-0">
              <div className="bg-white px-3.5 py-1 rounded-full border-2 border-red-600 shadow-md inline-flex items-center">
                <img 
                  src="/images/logos/pritilogo.webp" 
                  alt="Priti-Ji Official Brand Logo" 
            ...
            <div className="relative flex items-center justify-center w-full flex-1 min-h-0 my-auto overflow-hidden">
              ...
              <div className="flex items-center justify-center w-full h-full">
                <img 
                  src={pritiImages[modalIndex].webpUrl} 
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 pt-2 mt-2 w-full border-t border-gray-800 shrink-0">
              ...
              >
                <MessageCircle size={16} />
                <span>{t('btnWhatsAppOrder')} (₹70/- Pack)</span>
              </button>
            </div>
          </div>
        </div>
