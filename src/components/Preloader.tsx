        ...
        >
          <div className="preloader-content">
            <div className="preloader-emblem-wrap">
              ...
              <img src="https://i.pinimg.com/736x/d9/4f/27/d94f27adb01975c919f11aa8a998eb87.jpg" alt="Sarkar Enterprise Logo" className="preloader-logo-image" style={{ objectFit: 'contain' }} />
            </div>
