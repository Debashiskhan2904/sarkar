...
const AUTHORIZED_ADMIN_LIST = [
  ...
  { email: 'kishore8670@gmail.com', name: 'B.P. Kishore' },
  { email: 'kishore8670@googlemail.com', name: 'B.P. Kishore' },
    ...
    checkRedirectResult().then(redirectUser => {
      if (redirectUser) {
        ...
        if (authorizedEmail) {
          ...
          logout();
          const err = `Unauthorized account (${userEmails[0]}). Authorized administrators: B.P. Kishore (bpkishore2001@gmail.com, kishore8670@gmail.com), Debashis Khan (debashiskhan586@gmail.com)`;
                                ...
                                >
                                  <td>
                                    ...
                                    <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginTop: '2px', alignItems: 'center' }}>
                                      ...
                                      {j.creatorEmail && (
                                        <span style={{ fontSize: '0.72rem', color: '#ffd700', background: 'rgba(255,215,0,0.1)', padding: '1px 6px', borderRadius: '4px', border: '1px solid rgba(255,215,0,0.25)' }}>
                                          👤 {j.createdBy || j.creatorEmail}
                                        </span>
                                      )}
                                    </div>
                                  </td>
