...
export const FAQJsonLd: React.FC<FAQJsonLdProps> = ({ faqs, id = 'faq-structured-data' }) => {
  useEffect(() => {
    ...
    const schemaData = {
      ...
      '@type': 'FAQPage',
      '@id': 'https://sarkarenterprise.in/faq#faqpage',
...
export const ProductJsonLd: React.FC<ProductJsonLdProps> = ({ products, id = 'products-structured-data' }) => {
  useEffect(() => {
    ...
    const schemaData = {
      '@context': 'https://schema.org',
      '@type': 'ItemList',
      '@id': 'https://sarkarenterprise.in/products#itemlist',
      ...
      'itemListElement': products.map((prod, index) => ({
        ...
        'item': {
          ...
          'offers': {
            '@type': 'Offer',
            'url': 'https://sarkarenterprise.in/products',
