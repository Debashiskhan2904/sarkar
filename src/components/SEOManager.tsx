...
export const SEOManager = () => {
  ...
  useEffect(() => {
    ...
    setMetaTag('og:url', `https://www.businesspromoter2001.com${pathname === '/' ? '' : pathname}`, true);
    ...
    canonical.setAttribute('href', `https://www.businesspromoter2001.com${pathname === '/' ? '' : pathname}`);
