      ...
      <div className="container" style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 24px' }}>
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: '0 0 4px 0', display: 'flex', flexDirection: 'column', gap: '7px' }}>
              ...
              <li style={{ margin: 0, padding: 0, lineHeight: 1.4 }}>
                <a 
                  href="mailto:bpkishore2001@gmail.com" 
                  style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', color: 'rgba(255, 255, 255, 0.78)', fontSize: '0.82rem', textDecoration: 'none', transition: 'color 0.2s ease' }}
                  onMouseEnter={(e) => (e.currentTarget.style.color = '#FFD700')}
                  onMouseLeave={(e) => (e.currentTarget.style.color = 'rgba(255, 255, 255, 0.78)')}
                >
                  <Mail size={14} style={{ color: '#00d2ff', flexShrink: 0 }} />
                  <span>bpkishore2001@gmail.com</span>
                </a>
              </li>
              <li style={{ margin: 0, padding: 0, lineHeight: 1.4 }}>
                <a 
            ...
            >
              ...
              <span 
                ...
                title="Food Safety and Standards Authority of India Registration"
              >
                <span style={{ display: 'inline-flex', alignItems: 'center', fontWeight: 900, fontStyle: 'italic', letterSpacing: '-0.3px', fontSize: '0.75rem' }}>
                  <span style={{ color: '#22c55e' }}>f</span>
                  <span style={{ color: '#60a5fa' }}>ssa</span>
                  <span style={{ color: '#fb923c' }}>i</span>
                </span>
                <span style={{ color: 'rgba(255,255,255,0.6)' }}>No =</span>
                <span style={{ color: '#ffffff', fontWeight: 700, letterSpacing: '0.03em' }}>22824144000511</span>
              </span>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '8px' }}>
              {[
                ...
                { label: t('navCareers') || 'Careers', path: '/careers' },
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '14px', flexWrap: 'wrap' }}>
            ...
            <p style={{ margin: 0, fontSize: '0.76rem', color: 'rgba(255, 255, 255, 0.6)', display: 'inline-flex', alignItems: 'center', gap: '5px' }}>
              <span style={{ color: '#10b981', fontWeight: 800, fontStyle: 'italic' }}>fssai</span>
              <span>Reg:</span>
              <strong style={{ color: '#ffffff', letterSpacing: '0.04em' }}>22824144000511</strong>
            </p>
          </div>
