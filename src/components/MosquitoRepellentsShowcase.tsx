  ...
  const mosquitoImages = [
    {
      ...
      webpUrl: 'https://i.pinimg.com/736x/b1/61/57/b161574feafbb517bd5a5685e3de085d.jpg',
    ...
    },
    {
      ...
      webpUrl: 'https://i.pinimg.com/736x/c2/03/f7/c203f70725f20c7ebb0ef983cad7b98f.jpg',
      url: 'https://i.pinimg.com/736x/c2/03/f7/c203f70725f20c7ebb0ef983cad7b98f.jpg',
    ...
    },
    {
      ...
      webpUrl: 'https://i.pinimg.com/736x/03/5c/cf/035ccf72925e3420c10f5e10c339cbb3.jpg',
      url: 'https://i.pinimg.com/736x/03/5c/cf/035ccf72925e3420c10f5e10c339cbb3.jpg',
      remoteUrl: 'https://i.pinimg.com/736x/03/5c/cf/035ccf72925e3420c10f5e10c339cbb3.jpg'
    },
    {
      id: 'img-4',
      indexLabel: '4th',
      title: '4th: Mosquito Repellent Regional Trade & Supply Blueprint',
      sub: 'Wholesale Trade Incentives & Territory Dealership Distribution Network',
        ...
        <div className="mosquito-spec-column">
          ...
          <div className="mosquito-header-row">
            <div className="mosquito-header-left">
              {/* Official Mosquito Logo from public/images/logos/mosquito.webp */}
              <div className="mosquito-brand-logo-wrap" title="Angry Frog Instant Kill Logo">
                <img 
                  src="/images/logos/mosquito.webp" 
              ...
              <div className="mosquito-title-texts">
                <span className="mosquito-eyebrow">{t('mosquitoEyebrow')}</span>
                <h2 className="mosquito-main-title">{t('mosquitoTitle')}</h2>
              </div>
            </div>
            ...
            <div className="protection-tomorrow-badge">
              <div className="tomorrow-brush-bg">
                <span className="tomorrow-line-1">{t('mosquitoBadgeLine1')}</span>
                <span className="tomorrow-line-2">{t('mosquitoBadgeLine2')}</span>
                <span className="tomorrow-line-3">{t('mosquitoBadgeLine3')}</span>
              </div>
            </div>
          </div>
          ...
          <div className="mosquito-bullets-and-mascot">
            ...
            <div className="mosquito-mascot-container">
              ...
              <div className="stay-healthy-brush-banner">
                <span className="stay-line-1">{t('mosquitoStayLine1')}</span>
                <span className="stay-line-2">{t('mosquitoStayLine2')}</span>
              </div>
              ...
              <div className="frog-mascot-wrapper">
                ...
                <div className="mascot-placard">
                  <span className="placard-red-bold">{t('mosquitoNoDengue')}</span>
                  <span className="placard-red-bold">{t('mosquitoNoMalaria')}</span>
          ...
          >
            ...
            <div className="relative flex items-center justify-center w-full flex-1 min-h-0 my-auto overflow-hidden">
              ...
              <div className="flex items-center justify-center w-full h-full">
                <img 
                  src={mosquitoImages[modalIndex].webpUrl} 
