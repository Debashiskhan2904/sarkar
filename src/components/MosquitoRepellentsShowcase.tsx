  ...
  const features = [
    {
      ...
      label: 'Kills Instantly'
    },
    {
      icon: <ShieldAlert className="w-5 h-5 text-amber-400" />,
      label: 'Protects from Dengue, Malaria & Chikungunya'
    },
    {
      icon: <Leaf className="w-5 h-5 text-amber-400 fill-amber-400/20" />,
      label: 'Natural Herbal Formula'
    },
    {
    ...
    },
    {
      ...
      label: 'Pleasant Fragrance'
    },
    {
      icon: <Briefcase className="w-5 h-5 text-amber-400" />,
      label: 'Ideal for Home, Office & Travel'
    }
  ];

  // 8 Checklist bullet points with yellow circular checkmarks matching screenshot
  const bullets = [
    'Hawker / Cycle sales model (₹600/day potential)',
    '100% Guaranteed monthly income schemes',
    'Buy 2 Get 1 offers',
    'Full audio & video campaign support',
    'Natural herbal formulation with citronella',
    'Suitable for home, bedroom, office, outdoor & travel use',
    'Festival & seasonal demand support',
    'Marketing materials, demo support and dealership opportunities'
  ];

  // Highlight and regular tags matching screenshot
  const tags = [
    { text: '₹600/Day Hawker Model', highlight: true },
    { text: 'Buy 2 Get 1 Offer', highlight: true },
    { text: '100% Guaranteed Income', highlight: true },
    { text: 'Citronella Agarbatti', highlight: true },
    { text: 'Audio & Video Campaign Kit', highlight: false },
    { text: 'Home • Office • Travel', highlight: false },
    { text: 'Natural Herbal', highlight: false },
    { text: 'Long Lasting', highlight: false },
    { text: 'Family Safe', highlight: false }
  ];
