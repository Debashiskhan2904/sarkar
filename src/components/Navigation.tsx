      ...
      <nav className={`navbar ${scrolled ? 'scrolled' : ''}`} id="navbar">
        ...
        <div className="nav-inner">
          <NavLink to="/" className="logo" onClick={closeMenu}>
            <img src="https://i.pinimg.com/736x/d9/4f/27/d94f27adb01975c919f11aa8a998eb87.jpg" alt="The Sarkar Enterprise Logo" className="logo-image" />
            <span className="logo-brand" style={{ gap: '5px' }}>
