      ...
      <nav className={`navbar ${scrolled ? 'scrolled' : ''}`} id="navbar">
        <div className="nav-inner">
          ...
          <ul className={`nav-links ${mobileOpen ? 'open' : ''}`}>
            ...
            <li><NavLink to="/products" className={({isActive}) => isActive || location.pathname.startsWith('/products/') ? 'active' : ''} onClick={closeMenu}>PRODUCTS</NavLink></li>
            ...
            <li>
              <button className="admin-btn nav-login-btn" onClick={() => { setIsAdminOpen(true); closeMenu(); }}>LOGIN</button>
            </li>
          </ul>
